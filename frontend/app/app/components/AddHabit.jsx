...
import { onHabitSubmit } from "../habits/actions";
import revJournal from "../journal/actions";
...
export function DrawerDialogDemo() {
  ...
  async function onSubmit(event) {
    ...
    try {
      await onHabitSubmit({
        data: new FormData(event.currentTarget).get("habit_name"),
      });
      revHabits();
      setOpen(false);
    } catch (error) {
    ...
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent>
        <DrawerHeader className="text-left">
          <DrawerTitle>Build a New Habit</DrawerTitle>
